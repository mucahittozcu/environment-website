...
const handleSubmit = (e) => {
  ...
  return (
    ...
    <div className="flex justify-center items-center ">
      <img className="xl:w-[950px] lg:w-[550px] md:w-[450px] sm:w-[400px] w-[350px] h-screen rounded-tr-[40px] rounded-br-[40px] " src={"Rectangle 1 (2).png"} />
      <div className="flex justify-center items-center xl:pl-64 lg:pl-44 md:pl-44 sm:pl-44 pl-36 xl-w-[550px] lg:w-[300px] md:w-[200px] sm:w-[150px] w-[100px]">
       <div className="flex flex-col">
        ...
        <div className="relative">
         <FaUser className="absolute top-[30%] left-[2%] transform -translate-y-1/2 text-gray-500 " size={20} />
          <input 
            className="border border-black rounded-xl xl:w-[450px] xl:h-[60px] lg:w-[400px] lg:h-[55px] md:w-[350px] md:h-[50px] sm:w-[300px] sm:h-[50px] w-[250px] h-[50px]  mb-10 pl-10"
            type="text"
            required
            name="username"
