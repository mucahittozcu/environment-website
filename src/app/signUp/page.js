...
const handleSubmit = (e) => {
  ...
  return (
    ...
    <div className="flex justify-center items-center ">
      <img className="xl:w-[950px] lg:w-[550px] md:w-[420px] sm:w-[350px] w-[280px] h-screen rounded-tr-[40px] rounded-br-[40px] " src={"Rectangle 1 (2).png"} />
